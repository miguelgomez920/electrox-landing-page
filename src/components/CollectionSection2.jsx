...
//       {/* Caja de especificaciones en hover */}
//       {product.specs && (
//         <div className="pointer-events-none absolute inset-x-0 top-full mt-2 opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-200 z-20">
//           <div className="bg-black/90 border border-white/15 rounded-2xl p-3 text-[11px] text-gray-200 shadow-xl backdrop-blur-md">
...
export default function CollectionSection2({ productIDs = [] }) {
  ...
  return (
    ...
    <section className="py-20 bg-black/90">
     ...
     <section className="flex flex-col gap-4 px-30">
            ...
            <div className="relative flex gap-6 p-8 bg-white/5 border border-white/10 rounded-3xl ">
                ...
                <div className="flex flex-col justify-center gap-4">
                    ...
                    <div className="absolute  bottom-0 -right-4 translate-y-8 h-30 w-50 p-4 border border-white/10 rounded-2xl bg-black">
                      <p className="text-2xl font-bold">$199.99</p>
                      <p className="text-neutral-400 text-xs">$229.99</p>
                      <button className="bg-primary rounded-full font-semibold py-1 w-full mt-2 hover:scale-105 hover:shadow-lg hover:shadow-primary/40 transition">Añadir</button>
                    </div>
            </div>
        </section>
